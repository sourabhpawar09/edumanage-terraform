...
[![Real-World Problem](https://img.shields.io/badge/Real--World--Problem-blue?style=flat)](#real-world-problem)  
[![Design Objectives](https://img.shields.io/badge/Design--Objectives-green?style=flat)](#design-objectives)  
[![Architecture Breakdown & Rationale](https://img.shields.io/badge/Architecture--Breakdown-orange?style=flat)](#architecture-breakdown--rationale)  
 [![3.1 Networking Layer](https://img.shields.io/badge/3.1-Networking-blue?style=flat)](#31-networking-layer-vpc--subnets)  
 [![3.2 Compute Layer](https://img.shields.io/badge/3.2-Compute-green?style=flat)](#32-compute-layer-ec2--auto-scaling)  
 [![3.3 Load Balancing Layer](https://img.shields.io/badge/3.3-Load--Balancing-yellow?style=flat)](#33-load-balancing-layer-alb)  
 [![3.4 Database Layer](https://img.shields.io/badge/3.4-Database-red?style=flat)](#34-database-layer-amazon-rds)  
 [![3.5 Storage Layer](https://img.shields.io/badge/3.5-Storage-blue?style=flat)](#35-storage-layer-s3)  
 [![3.6 DNS & TLS](https://img.shields.io/badge/3.6-DNS--TLS-purple?style=flat)](#36-dns--tls-route-53--acm)  
 [![3.7 Observability](https://img.shields.io/badge/3.7-Observability-orange?style=flat)](#37-observability-cloudwatch)  
 [![3.8 IaC & Repeatability](https://img.shields.io/badge/3.8-IaC--Terraform-green?style=flat)](#38-iac--repeatability-terraform)  
 [![3.9 Security Layer](https://img.shields.io/badge/3.9-Security-red?style=flat)](#39-security-layer-iam--security-groups)  
 [![3.10 Backup & Recovery](https://img.shields.io/badge/3.10-Backup--Recovery-blue?style=flat)](#310-backup--recovery)  

[![Security Considerations & Best Practices](https://img.shields.io/badge/Security--Best--Practices-purple?style=flat)](#security-considerations--best-practices)  
[![Backup & Recovery](https://img.shields.io/badge/Backup--Recovery-red?style=flat)](#backup--recovery)  
[![Tech Stack & Tools Used](https://img.shields.io/badge/Tech--Stack--Tools-blue?style=flat)](#tech-stack--tools-used)  
[![Step-by-Step Deployment Instructions](https://img.shields.io/badge/Deployment--Steps-yellow?style=flat)](#step-by-step-deployment-instructions)  
 [![7.1 Prerequisites](https://img.shields.io/badge/7.1-Prerequisites-blue?style=flat)](#71-prerequisites)  
 [![7.2 Setup Repository](https://img.shields.io/badge/7.2-Setup--Repository-green?style=flat)](#72-setup-repository)  
 [![7.3 Initialize Terraform](https://img.shields.io/badge/7.3-Initialize--Terraform-orange?style=flat)](#73-initialize-terraform)  
 [![7.4 Plan Infrastructure](https://img.shields.io/badge/7.4-Plan--Infrastructure-red?style=flat)](#74-plan-infrastructure)  
 [![7.5 Apply Infrastructure](https://img.shields.io/badge/7.5-Apply--Infrastructure-blue?style=flat)](#75-apply-infrastructure)  
 [![7.6 Post-Deployment Checks](https://img.shields.io/badge/7.6-Post--Deployment-blue?style=flat)](#76-post-deployment-checks)  
  [![7.6.1 EC2 & ALB](https://img.shields.io/badge/7.6.1-EC2--ALB-green?style=flat)](#761-ec2--alb)  
  [![7.6.2 RDS](https://img.shields.io/badge/7.6.2-RDS-orange?style=flat)](#762-rds)  
  [![7.6.3 S3 Buckets](https://img.shields.io/badge/7.6.3-S3--Buckets-red?style=flat)](#763-s3-buckets)  
  [![7.6.4 Route 53 & ACM](https://img.shields.io/badge/7.6.4-Route--53--ACM-blue?style=flat)](#764-route-53--acm)  
  [![7.6.5 CloudWatch, Monitoring & Alerts](https://img.shields.io/badge/7.6.5-CloudWatch--Monitoring-green?style=flat)](#765-cloudwatch-monitoring--alerts)  
  [![7.6.6 Optional Functional Checks](https://img.shields.io/badge/7.6.6-Optional--Functional-blue?style=flat)](#766-optional-functional-checks)  
 [![7.7 Optional CI/CD & Monitoring Setup](https://img.shields.io/badge/7.7-Optional--CI--CD-blue?style=flat)](#77-optional-cicd--monitoring-setup)  
 [![7.8 Destroy Infrastructure](https://img.shields.io/badge/7.8-Destroy--Infrastructure-red?style=flat)](#78-destroy-infrastructure-optional)  
 [![7.9 Verification Tools](https://img.shields.io/badge/7.9-Verification--Tools-green?style=flat)](#79-verification-tools-optional)  
 [![7.10 Cost Awareness](https://img.shields.io/badge/7.10-Cost--Awareness-orange?style=flat)](#710-cost-awareness-optional)  

[![Cost Considerations & Optimizations](https://img.shields.io/badge/Cost--Optimizations-yellow?style=flat)](#cost-considerations--optimizations)  
[![Future Enhancements](https://img.shields.io/badge/Future--Enhancements-blue?style=flat)](#future-enhancements)
